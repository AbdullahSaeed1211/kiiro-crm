...
Current work remains local and uncommitted. See the checklist's dated implementation/evidence snapshot for the Calendar grid and auth password-visibility fixes, prior currency/task-description changes, test status, and explicitly unverified 390px/console/new-deal/conversion paths.
