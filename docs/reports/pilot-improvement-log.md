...
| Mobile timeline and Safari hydration follow-up                    | M3-L1 attempt 26; `pnpm verify` and scope checks pass; Worker-preview E2E passes 46/46 with no skips; mobile touch-event drag persists and restores dates; deterministic UTC activity timestamps avoid Safari hydration mismatch; no client records or placeholder copy created                                                       | complete |
