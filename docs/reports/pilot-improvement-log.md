...
| Notification task context                                         | Worker-preview E2E passes 48/48 serially; an intercepted unread task alert sends the mark-read request, opens the task panel over Calendar, and Escape restores Calendar; no notification or CRM record was created                                                                                                                   | complete |
