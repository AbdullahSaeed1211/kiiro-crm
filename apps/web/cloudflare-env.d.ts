/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 6e21a8abbddaf4466c8ce00bd0a2b407)
...
interface __BaseEnv_CloudflareEnv {
	...
	WORKER_SELF_REFERENCE: Fetcher /* ops-mirchmedia */ | Service<typeof import("./worker").default>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker");
	}
	interface MirchmediaEnv {
		R2: R2Bucket;
		D1: D1Database;
		EMAIL: SendEmail;
		RATE_LIMIT_INTAKE: RateLimit;
		...
		TENANT_SLUG: string;
		INBOUND_DOMAIN: string;
		WORKER_SELF_REFERENCE: Fetcher /* ops-mirchmedia */;
	}
