/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: d8360f6edaa609895bd0b50d077e471b)
// Runtime types generated with workerd@1.20260911.1 2025-08-15 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	R2: R2Bucket;
	D1: D1Database;
	EMAIL: SendEmail;
	RATE_LIMIT_INTAKE: RateLimit;
	...
	WORKER_SELF_REFERENCE: Fetcher /* ops-staging-a */ | Fetcher /* ops-staging-b */ | Service<typeof import("./worker").default>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker");
	}
	interface StagingAEnv {
		R2: R2Bucket;
		D1: D1Database;
		EMAIL: SendEmail;
		RATE_LIMIT_INTAKE: RateLimit;
		...
		TENANT_SLUG: string;
		INBOUND_DOMAIN: string;
		WORKER_SELF_REFERENCE: Fetcher /* ops-staging-a */;
	}
	interface StagingBEnv {
		R2: R2Bucket;
		D1: D1Database;
		EMAIL: SendEmail;
		RATE_LIMIT_INTAKE: RateLimit;
		...
		TENANT_SLUG: string;
		INBOUND_DOMAIN: string;
		WORKER_SELF_REFERENCE: Fetcher /* ops-staging-b */;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PAYLOAD_SECRET" | "INTERNAL_SECRET" | "TENANT_SECRET" | "TURNSTILE_SECRET" | "TURNSTILE_HOSTNAMES" | "MAIL_TRANSPORT" | "MAIL_FROM_ADDRESS" | "MAIL_FROM_NAME" | "APP_ORIGIN" | "TENANT_SLUG" | "INBOUND_DOMAIN">> {}
}
