/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 21e2fa2e885e5ab82b7de0fd8d8f292f)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PAYLOAD_SECRET" | "INTERNAL_SECRET" | "TENANT_SECRET" | "TURNSTILE_SECRET" | "TURNSTILE_HOSTNAMES" | "MAIL_TRANSPORT" | "APP_ORIGIN" | "TENANT_SLUG" | "INBOUND_DOMAIN">> {}
}
